...
export const roster = [
  {
    ...
    bio: 'Ex Agente Do Governo agora supostamente aposentado, Rick tem anos de experiência como hacker e programador avançado, curiosamente ele é apaixonado pelo seu time do coração Fortaleza',
    stats: [
      { label: 'Estilo', value: 'Alto Intelecto' },
  ...
  },
  {
    ...
    bio: 'Vindo de escórias becos e gangues, cara pintado de cinza sla e usando terno e balde, antigamente disfarce e agora uma nova identidade: dragon, utilizando-se de um balde para cometer atos de merda e caos pela cidade.',
    stats: [
      { label: 'Estilo', value: 'Neutro' },
      { label: 'Apelido', value: 'Rafz' },
      { label: 'Arma Preferida', value: 'Skill' },
      { label: 'Nível de Perigo', value: '★★★★★' },
    ],
  },
  {
    ...
    stats: [
      { label: 'Estilo', value: 'Trio' },
      { label: 'Marca Registrada', value: 'GTA' },
      { label: 'Arma Preferida', value: 'Glock 17' },
      { label: 'Nível de Perigo', value: '★★★★☆' },
    ],
  },
  {
    ...
    stats: [
      ...
      { label: 'Marca Registrada', value: 'Caos' },
